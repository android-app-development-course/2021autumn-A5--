...
open class SignInViews(context: Context?, attrs: AttributeSet?) : androidx.appcompat.widget.AppCompatButton(
    context!!, attrs){
...
//        paint= Paint() // 创建画笔
        ...
        mGradientDrawable!!.cornerRadius = 340f //按钮圆角度
